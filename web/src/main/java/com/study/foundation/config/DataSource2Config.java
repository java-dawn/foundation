...
@Configuration
@MapperScan(basePackages = "com.study.foundation.dao2", sqlSessionTemplateRef  = "sqlSessionTemplate2")
public class DataSource2Config {
    ...
    public SqlSessionFactory testSqlSessionFactory(@Qualifier("twoDataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mybatis/mapper/dao2/*.xml"));
